...
{
	public class SqlLiteDbConnectionInterceptor : AbstractDbConnectionInterceptor
	{
		/// <summary>
		/// Creates a new NhUnitOfWorkInterceptor object.
		/// </summary>
		/// <param name="sqlLiteSessionFactory">Nhibernate session factory.</param>
		public SqlLiteDbConnectionInterceptor(ISessionFactory sqlLiteSessionFactory)
		{
			SessionFactory = sqlLiteSessionFactory;
		...
		public override void Intercept(IInvocation invocation)
		{
			...
			if (DbConnectionUnit.Current != null || !AttributesHelper.HasSqlLiteDbConnectionAttribute(invocation.MethodInvocationTarget))
			{
				invocation.Proceed();
				return;
			}
